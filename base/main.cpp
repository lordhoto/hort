...
int main(int argc, char *argv[]) {
	...
	for (int i = 0; i < 78; ++i)
		for (int j = 0; j < 21; ++j)
			win2->printChar('.', i, j);
	win2->printChar('@', 0, 0, kWhiteOnBlack, kAttribBold | kAttribReverse);
	...
	win2->printChar('@', 3, 1, kWhiteOnBlack);
	win2->printChar('@', 3, 2, kWhiteOnBlack, kAttribBold);
	win2->printChar('@', 3, 3, kWhiteOnBlack, kAttribDim);
	win2->printChar('@', 3, 4, kGreenOnBlack, kAttribDim);
